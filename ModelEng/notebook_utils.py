...
def show_compare_training_accuracy(histories, names, key='total', save_path=None, colors=['b-', 'g-'], step_size = 1):
    """
    compares training accuracies from two histories

    :param histories: histories as generated by our model training
    :param names: the names for the histories that should be plotted
    :param key: the key of accuracy which should be compared (total,rock,paper,scissors)
    :param save_path: where to save the figure
    :param colors: the colors that should be displayed as used by matplotlib
    :param step_size: the stepsize (e.g. if histories contains entries after each 10 steps)
    """
    import matplotlib.pyplot as plt
    fig, ax = plt.subplots()
...
def show_compare_training_loss(histories, names, save_path=None, colors=['b-', 'g-'], step_size=1):
    """
    compares training loss of at least two histories
